	...
	public static function ajax_callback() {
		if ( isset( $_POST['security'] ) && wp_verify_nonce( $_POST['security'], 'dot-irecommendthis-nonce' ) ) {
			...
			if ( isset( $_POST['recommend_id'] ) ) {
				...
				echo Themeist_IRecommendThis_Content::dot_recommend_this( $post_id, $text_zero_suffix, $text_one_suffix, $text_more_suffix, 'update' );
			} else {
				$post_id = intval( str_replace( 'dot-irecommendthis-', '', $_POST['post_id'] ) );
				echo Themeist_IRecommendThis_Content::dot_recommend_this( $post_id, $text_zero_suffix, $text_one_suffix, $text_more_suffix, 'get' );
			}
		} else {
